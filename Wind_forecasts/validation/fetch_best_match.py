...
MODEL_LABEL = "Open-Meteo Best Match"
MODEL = "best_match"
CELL_SELECTION = "nearest"

BASE_OUTPUT_DIR = os.path.join("data", "validation", "best_match")
...
cache_session = requests_cache.CachedSession(".cache_validation_best_match", expire_after=3600)
