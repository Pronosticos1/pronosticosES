...
MODEL_LABEL = "ECMWF IFS - celda land"
MODEL = "ecmwf_ifs"
CELL_SELECTION = "land"

BASE_OUTPUT_DIR = os.path.join("data", "validation", "ecmwf_land")
...
cache_session = requests_cache.CachedSession(".cache_validation_ecmwf_land", expire_after=3600)
