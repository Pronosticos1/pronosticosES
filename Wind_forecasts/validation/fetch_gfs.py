...
MODEL_LABEL = "NCEP GFS Seamless"
MODEL = "ncep_gfs_seamless"
CELL_SELECTION = "nearest"

BASE_OUTPUT_DIR = os.path.join("data", "validation", "gfs")
...
cache_session = requests_cache.CachedSession(".cache_validation_gfs", expire_after=3600)
